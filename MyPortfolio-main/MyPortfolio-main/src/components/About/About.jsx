        ...
        <div className="terminal-box about-terminal">
          ...
          <div className="terminal-content">
            ...
            <p className="description">
              Computer Engineering student at Modern Education Society's Wadia College of
              Engineering, Pune. Passionate about creating amazing web experiences and ready
          ...
          <div className="terminal-content">
            ...
            <div className="education-cards">
              <div className="education-card">
                ...
                <p className="card-value">B.E Computer Engineering</p>
              </div>
              <div className="education-card">
                <div className="card-icon">
                  <FaAward />
                ...
                <p className="card-value">M.E.S Wadia College Of Engineering</p>
              </div>
              <div className="education-card">
                <div className="card-icon">
                  <FaMapMarkerAlt />
                ...
                <p className="card-value">Pune, Maharashtra</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="qualities-section">
        <div className="qualities-grid">
          <div className="quality-card">
            ...
            <p>Computer Engineering student at M.E.S Wadia College of Engineering, Pune with strong foundation in programming and problem-solving</p>
          </div>
          <div className="quality-card">
            <div className="quality-icon">
              <FaLaptopCode />
        ...
        <div className="terminal-box quote-terminal">
          ...
          <div className="terminal-content">
            ...
            <blockquote>
              ...
              <footer>– <span className="highlight">Ayush Kesharwani</span></footer>
            </blockquote>
          </div>
        </div>
      </div>
