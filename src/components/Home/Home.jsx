...
const lines = [
  ...
  {
    type: 'image',
    src: '/assets/p.jpg', // Update with your actual image path
    alt: 'Profile Image',
  },
  { type: 'command', text: '$ whoami' },
  { type: 'name', text: 'Ayush Kesharwani' },
  {
    type: 'description',
    text: 'Third Year Student | Computer Engineering | MESWCOE, Pune',
  },
  { type: 'command', text: '$ cat current_role.txt' },
  { type: 'highlight', text: 'FullStack Developer' },
  { type: 'command', text: '$ cat academic_info.json' },
  {
    type: 'list',
    items: [
      [<FaGraduationCap key="degree" className="icon" />, 'Degree: B.E in Computer Engineering'],
      [<FaLaptopCode key="dsa" className="icon" />, 'DSA: 500+ Problems'],
      [<FaGraduationCap key="grad" className="icon" />, 'Graduation: 2027'],
      [<FaCode key="proj" className="icon" />, 'Projects: 15+'],
    ],
  },
  ...
  { type: 'command', text: '$ cat contact.info' },
  {
    type: 'contact',
    items: [
      [<FaEnvelope key="email" className="icon" />, 'kesharwaniayush1207@gmail.com'],
      [<FaPhoneAlt key="phone" className="icon" />, '+91 9588430618'],
    ],
  },
  ...
  return (
    <div className="terminal-wrapper">
      <div className="terminal-header">
        ...
        <span className="terminal-title">Ayush_portfolio.exe</span>
      </div>
